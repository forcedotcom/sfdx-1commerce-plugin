...
export default class SearchIndex extends SfdxCommand {
    ...
    public static examples = [`sfdx 1commerce:search:start -n storeName
...
`    ];
    ...
    protected static flagsConfig = {
        name: flags.string({ char: 'n', description: 'name of webstore to index', exclusive: ['id'] }),
        id: flags.string({ char: 'i', description: 'ID of webstore to index', exclusive: ['name'] })
    };
